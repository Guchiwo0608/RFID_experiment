    ...
    public void onTagReported(ImpinjReader reader, TagReport report) {
        ...
        try {
            ...
            for (Tag t : tags) {
                ...
                tagMap.put("antenna" + antennaNumber + ".firstSeenTime", String.valueOf(t.getFirstSeenTime()));
                tagMap.put("antenna" + antennaNumber + ".LastSeenTime", String.valueOf(t.getLastSeenTime()));
